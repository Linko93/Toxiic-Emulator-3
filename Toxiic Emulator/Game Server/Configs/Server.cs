...
namespace Game_Server.Configs
{
    class Server
    {
        ...
        public static string SystemName = "SYSTEM"; // Server chat (like SYSTEM >> You are muted -> Example >> You are muted)
        ...
        internal class Player
        {
            ...
            public static bool CouponEvent = false; // Yes = Client open is allowed / No = Isn't allowed
            public static bool CarePackage = false; // Yes = Client open is allowed / No = Isn't allowed
        ...
        {
            public static string name = "AntiCheat";
        ...
        internal class Channels
        {
            ...
            public static bool Zombie = false; // True = Joinable - False = Not joinable
        ...
        internal class Experience
        {
            ...
            public static double DinarRate = 3; // Dinar Rate 
