...
namespace Game_Server
{
    ...
    class User : IDisposable
    {
        ...
        {
            if(SecurityManager.IsAllLettersOrDigits(Log))
            {
            ...
            {
                Console.WriteLine("Blocked string: " + Log);
            }
                        ...
                        case "hwban":
                            {
                                ...
                                if (target != null)
                                {
                                    if (rank > target.rank)
                                    {
                                        ...
                                        {
                                            Console.Write("blocked string: " + nickname);
                                        }
        ...
        public void OnDie()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("OnDie something went wrong " + ex);
            }
